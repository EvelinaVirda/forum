  ...
  <div class="l-sidebar">
    ...
    <div class="l-sidebar__content">
      <nav class="c-menu js-menu">
        <ul class="u-list">
          <li class="c-menu__item has-submenu" data-toggle="tooltip" title="member">
          ...
          <li class="c-menu__item is-active" data-toggle="tooltip" title="Modules">
...
<main class="l-main">
  <div class="content-wrapper content-wrapper--with-bg">
    <h1 class="page-title">Komentar</h1>
    ...
    $query = mysqli_query($connect, "SELECT * FROM komentar") or die(mysqli_error());
    ...
    if(mysqli_num_rows($query) == 0){  
      ...
      while($data = mysqli_fetch_assoc($query)){ 
        ?>
          ...
          echo '<td>'.$data['isi'].'</td>';  
          echo '<td><a href="hapus_komentar.php?id='.$data['id_komen'].'" onclick="return confirm(\'Yakin?\')">Hapus</a></td>';
        echo '</tr>';?>
